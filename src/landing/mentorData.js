export const mentors = [
  ...
  },
  {
    ...
    experience: "6+ tahun",
    summary: "Expert dalam JavaScript ecosystem dan modern web development. Passionate dalam mengajarkan best practices dan clean code.",
    education: [
      "S1 Sistem Informasi, Universitas Airlangga Surabaya",
    ...
    workExperience: [
      {
        ...
        description: "Mengajar JavaScript, React, dan Node.js untuk berbagai level dari pemula hingga advanced."
      },
      {
        title: "Lead Frontend Developer",
        company: "E-Commerce Indonesia",
        period: "2019 - 2021",
        description: "Membangun dan maintain platform e-commerce dengan traffic 1M+ users/month."
      },
      {
        title: "Full Stack JavaScript Developer",
        company: "Tech Startup Hub",
        period: "2017 - 2019",
        description: "Mengembangkan berbagai web application menggunakan MERN stack."
      }
    ],
    skills: [
      "JavaScript",
    ...
    achievements: [
      "Mengajar 800+ siswa JavaScript",
      "Develop 30+ production web apps",
      "Tech blogger dengan 50K+ followers",
      "Maintainer beberapa npm packages",
      "Workshop instructor di tech events"
    ],
    socialMedia: {
      linkedin: "https://linkedin.com/in/ahmadrizkipratama",
      github: "https://github.com/ahmadrizki",
      tiktok: "https://www.tiktok.com/@rizki.dev"
    }
  },
  {
    id: 5,
    ...
    experience: "5+ tahun",
    summary: "Data Scientist dengan expertise dalam Python programming dan Machine Learning. Berpengalaman dalam real-world data analytics projects.",
    education: [
      "S2 Data Science, Universitas Indonesia",
    ...
    workExperience: [
      {
        ...
        description: "Mengajar Python programming dan data science untuk pemula hingga intermediate."
      },
      {
        title: "Data Scientist",
        company: "Banking & Finance Corp",
        period: "2020 - 2022",
        description: "Membangun ML models untuk fraud detection dan customer segmentation."
      },
      {
        title: "Junior Data Analyst",
        company: "Retail Analytics Inc",
        period: "2018 - 2020",
        description: "Analisis data penjualan dan customer behavior untuk business insights."
      }
    ],
    skills: [
      "Python",
    ...
    achievements: [
      "Mengajar 500+ siswa Python & Data Science",
      "Published 5+ research papers",
      "Kaggle Competition medalist",
      "Speaker di data science conferences",
      "Consultant untuk 20+ data projects"
    ],
    socialMedia: {
      linkedin: "https://linkedin.com/in/sitinurhaliza",
      github: "https://github.com/sitinur",
      tiktok: "https://www.tiktok.com/@siti.datascience"
    }
  },
  {
    id: 6,
    ...
    experience: "7+ tahun",
    summary: "Expert Android Developer dengan fokus pada Kotlin dan modern Android development. Passionate dalam clean architecture dan best practices.",
    education: [
      "S1 Teknik Komputer, Universitas Gadjah Mada",
    ...
    workExperience: [
      {
        ...
        company: "PT Ubay Solusi Teknologi",
        period: "2021 - Sekarang",
        description: "Mengajar Kotlin dan Android development dengan fokus pada best practices."
      },
      {
        title: "Senior Android Developer",
        company: "Ride-Hailing Company",
        period: "2019 - 2021",
        description: "Develop dan maintain aplikasi mobile dengan 5M+ downloads."
      },
      {
        title: "Android Developer",
        company: "Mobile Apps Studio",
        period: "2016 - 2019",
        description: "Membangun berbagai aplikasi Android untuk klien lokal dan internasional."
      }
    ],
    skills: [
      "Kotlin",
    ...
    achievements: [
      "Mengajar 600+ siswa Kotlin & Android",
      "Develop 40+ apps (10M+ total downloads)",
      "Tech reviewer untuk Android publications",
      "Speaker di Android developer meetups",
      "Mentor untuk startup mobile projects"
    ],
    socialMedia: {
      linkedin: "https://linkedin.com/in/budisantoso",
      github: "https://github.com/budisan",
      tiktok: "https://www.tiktok.com/@budi.android"
    }
  },
  {
    id: 7,
    ...
    experience: "5+ tahun",
    summary: "Flutter specialist dengan passion di mobile UI/UX design. Expertise dalam membangun beautiful and performant cross-platform apps.",
    education: [
      "S1 Desain Komunikasi Visual, Institut Seni Indonesia",
      "Google Flutter Developer Certification",
      "UI/UX Design Professional Certificate"
    ],
    workExperience: [
      {
        title: "Flutter Instructor & UI/UX Mentor",
        company: "PT Ubay Solusi Teknologi",
        period: "2022 - Sekarang",
        description: "Mengajar Flutter development dengan fokus pada UI/UX best practices."
      },
      {
        title: "Lead Flutter Developer",
        company: "Health-Tech Startup",
        period: "2020 - 2022",
        description: "Membangun aplikasi kesehatan cross-platform dengan Flutter."
      },
      {
        title: "Mobile Developer",
        company: "Creative Digital Agency",
        period: "2018 - 2020",
        description: "Develop mobile apps untuk berbagai klien dengan fokus pada UI/UX excellence."
      }
    ],
    skills: [
      "Flutter",
    ...
    achievements: [
      "Mengajar 700+ siswa Flutter",
      "Design & develop 35+ mobile apps",
      "UI/UX consultant untuk 15+ projects",
      "Speaker di Flutter meetups",
      "Published Flutter tutorials on YouTube (50K+ subscribers)"
    ],
    socialMedia: {
      linkedin: "https://linkedin.com/in/dewikusumaputri",
      github: "https://github.com/dewikusuma",
      tiktok: "https://www.tiktok.com/@dewi.flutter"
    }
  },
  {
    id: 8,
    ...
    experience: "7+ tahun",
    summary: "Backend architect dengan expertise dalam Node.js dan microservices. Fokus pada scalable dan maintainable backend systems.",
    education: [
    ...
    workExperience: [
      {
        ...
        company: "PT Ubay Solusi Teknologi",
        period: "2021 - Sekarang",
        description: "Mengajar Node.js, REST API development, dan microservices architecture."
      },
      {
        title: "Backend Architect",
        company: "Fintech Company",
        period: "2019 - 2021",
        description: "Design dan implement microservices architecture handling 10M+ transactions/month."
      },
      {
        title: "Senior Backend Developer",
        company: "SaaS Platform Inc",
        period: "2016 - 2019",
        description: "Build scalable backend systems menggunakan Node.js dan PostgreSQL."
      }
    ],
    skills: [
      "Node.js",
    ...
    achievements: [
      "Mengajar 600+ siswa Node.js",
      "Architect 25+ enterprise backend systems",
      "Tech speaker di backend conferences",
      "Open source contributor (Node.js ecosystem)",
      "Technical writer dengan 100+ published articles"
    ],
    socialMedia: {
      linkedin: "https://linkedin.com/in/ekoprasetyo",
      github: "https://github.com/ekopras",
      tiktok: "https://www.tiktok.com/@eko.backend"
    }
  }
];
